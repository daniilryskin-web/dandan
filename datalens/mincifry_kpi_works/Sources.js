...
//  Запрашиваются все четыре стадии, а не только показываемая: из них
//  считается знаменатель для полосы («70 из 235»), и один и тот же источник
//  годится для всех трёх индикаторов.
// ============================================================================
