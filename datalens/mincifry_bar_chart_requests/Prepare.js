// ============================================================================
//  Вкладка Prepare — Advanced-чарт: горизонтальный стек по типам услуг
...
const SERIES_SPEC = [
    {field: '0. Заявка не подана (индикатор)', aliases: ['0. Заявка не подана'],
     label: '0. Заявка не подана', color: BRAND.violet},
    {field: '1. Заявка подана (индикатор)', aliases: ['1. Заявка подана'],
     label: '1. Заявка подана', color: BRAND.violetLight},
    {field: '2. Заявка исполнена: (индикатор)', aliases: ['2. Заявка исполнена:'],
     label: '2. Заявка исполнена:', color: BRAND.violetDeep},
];
...
const X_FIELD = 'Тип';
const SOURCE_KEY = 'requests';
const TITLE = 'Заявки по типам услуг';

// Порядок категорий сверху вниз. Заданный список надёжнее сортировки: по
// алфавиту «Услуг Гостех» встало бы перед «Услуг ИЭП», а в вашем чарте
// наоборот. Категории, которых в списке нет, идут следом в порядке источника.
