...
const fields = [
    ...
    // Имя поля должно совпадать с датасетом дословно. В превью датасета оно
    // называется «Оставшиеся (индикатор)»; если у вас есть и поле
    // «Оставшиеся» без суффикса — подставьте то, которое нужно.
    {ref: {type: 'title', title: 'Оставшиеся (индикатор)'}},
];
