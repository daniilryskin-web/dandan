...
// Направления, которые всегда идут первыми, в указанном порядке. Остальные
// сортируются по ФОТ, как и раньше, — сверху самые крупные.
//
// Имя должно совпадать со значением колонки «Блок» побуквенно, включая
// пробелы и точки: «Цветков С.В.», а не «Цветков С. В.». Если написать
// с ошибкой, ничего не сломается — блок просто встанет по размеру,
